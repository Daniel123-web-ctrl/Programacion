...
public class Furgoneta extends Coche{  // aqui dispones de todo aquello que es  public de la clase Coche
    ...
    public Furgoneta(int plazaExtra,int capacidadCarga){
        ...
        super(); // este llama al constructor de la clase padre en este caso llama al constructor de Coche
